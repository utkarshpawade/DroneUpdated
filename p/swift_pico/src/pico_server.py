...
class WayPointServer(Node):
    ...
    def __init__(self):
        ...
        self.Kp = [60, 50, 29.8, 0]
        self.Ki = [0.01, 0.01, 0.015, 0.0]
        self.Kd = [1500, 1500, 800, 0]
    ...
    def altitude_set_pid(self,alt):
        self.Kp[3] = alt.kp * 1.0 
        self.Ki[3] = alt.ki * 0.001
        self.Kd[3] = alt.kd * 1.0
    ...
    def pid(self):
        ...
        self.pid_error.throttle_error = self.error[3]
        self.pid_error.pitch_error = self.error[2]
        self.pid_error.roll_error = self.error[1]
        self.pid_error.yaw_error = self.error[0]
        ...
        self.yaw = (self.Kp[0] * self.error[0] + 
					self.Ki[0] * self.sum_error[0] + 
					self.Kd[0] * self.diff_error[0])
